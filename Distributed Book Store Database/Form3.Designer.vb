...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        Me.Book_storeTableAdapter = New Distributed_Book_Store_Database.site1DataSetTableAdapters.book_storeTableAdapter()
        Me.BookstoreBindingSource1 = New System.Windows.Forms.BindingSource(Me.components)
        Me.Book_storeTableAdapter1 = New Distributed_Book_Store_Database.site2DataSetTableAdapters.book_storeTableAdapter()
        Me.BookstoreBindingSource2 = New System.Windows.Forms.BindingSource(Me.components)
        Me.Book_storeTableAdapter2 = New Distributed_Book_Store_Database.site3DataSetTableAdapters.book_storeTableAdapter()
        ...
        CType(Me.BookstoreBindingSource1, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.BookstoreBindingSource2, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'Button4
        '
        ...
        Me.Label1.Location = New System.Drawing.Point(323, 69)
        ...
        Me.BookstoreBindingSource.DataSource = Me.Site1DataSet
        '
        'Book_storeTableAdapter
        '
        Me.Book_storeTableAdapter.ClearBeforeFill = True
        '
        'BookstoreBindingSource1
        '
        Me.BookstoreBindingSource1.DataMember = "book_store"
        Me.BookstoreBindingSource1.DataSource = Me.Site2DataSet
        '
        'Book_storeTableAdapter1
        '
        Me.Book_storeTableAdapter1.ClearBeforeFill = True
        '
        'BookstoreBindingSource2
        '
        Me.BookstoreBindingSource2.DataMember = "book_store"
        Me.BookstoreBindingSource2.DataSource = Me.Site3DataSet
        '
        'Book_storeTableAdapter2
        '
        Me.Book_storeTableAdapter2.ClearBeforeFill = True
        '
        'Form3
        '
        ...
        CType(Me.BookstoreBindingSource1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.BookstoreBindingSource2, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents Book_storeTableAdapter As site1DataSetTableAdapters.book_storeTableAdapter
    Friend WithEvents BookstoreBindingSource1 As BindingSource
    Friend WithEvents Book_storeTableAdapter1 As site2DataSetTableAdapters.book_storeTableAdapter
    Friend WithEvents BookstoreBindingSource2 As BindingSource
    Friend WithEvents Book_storeTableAdapter2 As site3DataSetTableAdapters.book_storeTableAdapter
End Class
